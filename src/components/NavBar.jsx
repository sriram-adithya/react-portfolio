...
const NavBar = () => {
    ...
    return (
        <div className="flex justify-between items-center w-full h-15 text-white bg-black px-4">
            <div>
                <h1 className="text-4xl sm:text-5xl font-signature ml-2 mt-4">Sriram Adithya</h1>
            </div>
