...
const About = () => {
  return (
    <div
      name="About"
      className="h-screen bg-gradient-to-b from-gray-800 to-black text-white w-full py-24 px-4"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col justify-center h-auto w-full">
        <div className="pb-8">
